...
import (
	...
	"github.com/pmker/onegw/ethereum/wrappers"
...
// The most addresses we can fetch balances for in a single CALL without going over the gateway gas
// limit. One of Geth/Parity caps the gas limit for `eth_call`s at the gateway gas limit.
